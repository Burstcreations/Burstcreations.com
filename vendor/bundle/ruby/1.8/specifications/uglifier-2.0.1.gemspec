...
Gem::Specification.new do |s|
  ...
  s.files = [".document", ".gitmodules", ".rspec", ".travis.yml", "CONTRIBUTING.md", "Gemfile", "LICENSE.txt", "README.md", "Rakefile", "VERSION", "lib/es5.js", "lib/uglifier.rb", "lib/uglify.js", "spec/source_map_spec.rb", "spec/spec_helper.rb", "spec/uglifier_spec.rb", "uglifier.gemspec"]
